...
describe("Availability display", () => {
    ...
    it("Sources spell school and level from data when availaility is not set", () => {
        ...
        expect(actual).to.deep.contain({label: "illusionmagic 1", skillId: "illusionmagic", spellLevel: "1"});
    });
    ...
    it("Transforms several skill availabilities", () => {
        ...
        expect(actual).to.deep.contain(
            {label: "illusionmagic 1", skillId: "illusionmagic", spellLevel: "1"},
            {label: "deathmagic 2", skillId: "deathmagic", spellLevel: "2"}
        );
    });
    ...
    it("Handles incorrectly formatted list", () => {
        sampleSpell.system.availableIn = "illusionmagic:1 deathmagic:2";
        const actual = sampleSpell.availableInList;
        expect(actual[0]).to.deep.contain({label: "illusionmagic 1", skillId: "illusionmagic", spellLevel: "1"});
    });
