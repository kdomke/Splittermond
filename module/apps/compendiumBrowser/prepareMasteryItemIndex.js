 ...
 */
export function prepareMasteryItemIndex(compendiumMetadata, itemIndexEntity) {
...
function initializeTagGenerator(item){
    ...
    if(!(property in item)) {
        Object.defineProperty(item,
            ...
            {
                get: function () {
                   return produceMasteryTags(this.system, getMasteryAvailabilityParser(game.i18n, CONFIG.splittermond.skillGroups.magic));
                }
            });
    }
}
